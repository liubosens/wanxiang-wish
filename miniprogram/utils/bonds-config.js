// 图鉴羁绊组合 —— 与 web/core/bonds-config.js、cloudflare/src/bonds-config.ts 同源（改动必须同步）。
...
// 已激活加成之和（加算，未封顶）
function bondBonusSum(inventory) {
...
module.exports = { BOND_CAP, BONDS, bondStates, bondBonusSum, bondBonus };
